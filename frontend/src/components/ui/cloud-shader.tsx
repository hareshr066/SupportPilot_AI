...
void main() {
  ...
  color = cloudPass(color, sky, p, aspect, t, 0.135, 0.48, 0.20, vec2(0.56, 0.24), 57.2, 0.0);
...
export const CloudShader = ({
  ...
  useEffect(() => {
    ...
    const draw = (now: number) => {
      ...
      const targetH = Math.max(1, Math.floor(rect.height || canvas.clientHeight || 360));
